...
path2 = np.linspace(0.0015, -0.001, 200)[1:]  # 2. Разгрузка и уход в сильное сжатие
path3 = np.linspace(-0.001, 0.0005, 250)[1:]  # 3. Повторное нагружение (идем дальше максимума!)
