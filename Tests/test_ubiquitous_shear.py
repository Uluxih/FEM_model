...
def run_multi_element_test():
    ...
    joint_params = {
        ...
        'kn': 0.001,  # Нормальная жесткость (Па/м)
        'ks': 0.001,  # Сдвиговая жесткость (Па/м)
        'kt': 0.001,  # Сдвиговая жесткость (Па/м)
        'spacing': 0.02,  # Расстояние между трещинами (м)
