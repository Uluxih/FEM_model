...
def find_critical_plane_shear(stress_tensor, material, mode='3D', num_planes=20):
    best_params = None
    max_f = -float('inf')
...
def find_critical_plane_tensile(stress_tensor, material, mode='3D', num_planes=20):
    best_params = None
    max_f = -float('inf')
...
def find_critical_plane_compression(stress_tensor, material, mode='3D', num_planes=20):
    best_params = None
    max_f = -float('inf')
